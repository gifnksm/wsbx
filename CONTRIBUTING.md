...
First off, thank you for considering contributing to wsbx.
...
[issue tracker](https://github.com/gifnksm/wsbx/issues),
...
[CHANGELOG](https://github.com/gifnksm/wsbx/blob/main/CHANGELOG.md)
...
```console
git clone https://github.com/gifnksm/wsbx
cd wsbx
cargo test
```
